...
const variantMarkers = {
  default: "sx-badgevariantdefault",
  secondary: "sx-badgevariantsecondary",
  destructive: "sx-badgevariantdestructive",
  outline: "sx-badgevariantoutline",
};
...
function badgeVariants({
  ...
  return cn(
    stylex.props(variant ? variantStyles[variant] : styles.badgeBase, xstyle)
      .className,
...
function Badge({
  ...
  VariantOptions & { asChild?: boolean }) {
